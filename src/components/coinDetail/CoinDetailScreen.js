...
import { Alert, View, Text, Image, Pressable, StyleSheet, SectionList, FlatList } from 'react-native';
...
class CoinDetailScreen extends Component {
    ...
    getSymbolIcon = (coinId) => {
        ...
        if(coinId){
            ...
            const symbol = coinId.toLowerCase().replace(' ','-');

            //const url = `https://api.coinlore.net/api/coin/markets/?id=${symbol}`;
            //const url = `https://c1.coinlore.com/img/25x25/${symbol}.png`;   
